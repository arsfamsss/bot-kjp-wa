...
export const FAQ_MESSAGE = [
    ...
    '4) Bot akan konfirmasi data berhasil/gagal',
    '',
    '📝 *FORMAT DATA*',
    ...
    '',
    '💡 *TIPS*',
    '• Pasarjaya punya opsi *Lokasi Lain* — ketik nama lokasi, bot cari otomatis',
    '• Lokasi yang tutup tetap tampil dengan label *(TUTUP - buka jam XX.XX)*',
    '• Bisa langsung kirim data tanpa pilih lokasi — bot akan tanya lokasi dulu',
    '',
    '❗ *DATA DITOLAK?*',
