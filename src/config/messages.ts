...
export const FAQ_MESSAGE = [
    ...
    '📌 Di luar jam, lokasi tampil tapi tidak bisa dipilih.',
    '',
    '📌 *CARA DAFTAR*',
    '1) Ketik *1* → pilih lokasi',
    '2) Pilih sub-lokasi (jika ada)',
    '3) Kirim data sesuai format',
    '4) Akan ada konfirmasi data berhasil/gagal',
    '',
    '📝 *FORMAT DATA*',
    '• *Pasarjaya*: 5 baris — Nama, Kartu, KTP, KK, Tgl Lahir',
    '• *Dharmajaya*: 4 baris — Nama, Jenis Kartu+Nomor, KTP, KK',
    '• *Foodstation*: 4 baris — Nama, Jenis Kartu+Nomor, KTP, KK',
    '• Kirim banyak orang? Pisahkan dengan *1 baris kosong*',
    '',
    '💳 *ATURAN KARTU*',
    '• Nomor kartu *16-18 digit*, diawali *504948*',
    '• Jenis kartu: KJP, LANSIA, RUSUN, DISABILITAS, DASAWISMA, PEKERJA, GURU HONORER, PJLP, KAJ',
    '• Dharmajaya & Foodstation: tulis jenis kartu di baris ke-2',
    '  Contoh: *LANSIA 5049489000001234*',
    '',
    '🪪 *BATAS KTP*',
    '• 1 KTP = *1x sehari*',
    '• 1 KTP = maks *5x sebulan*',
    '',
    '🛠️ *PERINTAH*',
    '• *CEK* → lihat data (hari ini / kemarin / tanggal lain)',
    '• *EDIT* → pilih data → pilih field → ketik nilai baru',
    '• *HAPUS* → lihat daftar, lalu ketik *HAPUS 1* atau *HAPUS 1,2,3*',
    '• *BATAL* → batalkan data terakhir (maks *30 menit*)',
    '• *CEK STATUS PENDAFTARAN* → pilih provider → lihat hasil daftar',
    '  Pasarjaya: bisa pilih cek data kemarin atau hari ini',
    '• *MENU* → kembali ke menu utama',
    '',
    '💡 *TIPS*',
    '• Pasarjaya punya opsi *Lokasi Lain* — ketik nama lokasi, dicari otomatis',
    '• Lokasi yang tutup tetap tampil dengan label *(TUTUP - buka jam XX.XX)*',
    '• Bisa langsung kirim data tanpa pilih lokasi — nanti akan ditanya lokasi dulu',
    '',
    '❗ *DATA DITOLAK?*',
    'Cek: jumlah baris, panjang nomor, awalan 504948, dan jenis kartu.',
    'Masih kendala? Hubungi Admin 📞 *08568511113*',
    '',
...
export const ADMIN_MENU_MESSAGE = [
    ...
    '2️⃣ *Kelola Buka/Tutup Lokasi*',
    '3️⃣ *Export Data* (TXT & XLSX)',
    '4️⃣ *Rekap Data* (Hari Ini / Kemarin)',
    '5️⃣ *Hapus Data User*',
    '6️⃣ *Kelola Blokir Nomor* — KJP, KTP, KK, HP',
    '7️⃣ *Kelola Kuota Lokasi*',
    '8️⃣ *Kelola Kontak*',
    '9️⃣ *Kelola Whitelist HP*',
    '🔟 *Kelola Prefix Kartu*',
    '1️⃣1️⃣ *Laporan & Analitik*',
    '',
    '_Ketik *#TEMPLATE* untuk edit pesan tutup_',
    '_Ketik *#TEMPLATE RESET* untuk reset default_',
    '',
