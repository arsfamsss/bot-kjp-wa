...
export type UserFlowState =
    ...
    | 'CHECK_STATUS_SELECT_PROVIDER'
    | 'CHECK_STATUS_PASARJAYA_DATE'
    | 'DELETE_DATA'
    | 'SELECT_LOCATION'
...
export type AdminFlowState =
    ...
    | 'SETTING_CLOSE_TEMPLATE'
    | 'SETTING_MANUAL_CLOSE_START'
    | 'SETTING_MANUAL_CLOSE_END'
    | 'BLOCKED_KTP_MENU'
    | 'BLOCKED_KTP_DELETE'
    | 'BLOCKED_KTP_ADD_PERMANENT'
    | 'BLOCKED_KTP_ADD_TEMPORARY'
    | 'BLOCKED_KTP_CHANGE_TYPE'
    | 'BLOCKED_KTP_CHANGE_TYPE_CONFIRM'
    | 'BLOCKED_KJP_MENU'
    | 'BLOCKED_KJP_ADD'
    | 'BLOCKED_KJP_DELETE'
    | 'BLOCKED_KK_MENU'
    ...
    | 'LOCATION_MGMT_MENU'
    | 'LOCATION_MGMT_SELECT_PROVIDER'
    | 'LOCATION_MGMT_PROVIDER_ACTION'
    | 'LOCATION_MGMT_SELECT_SUB'
    | 'LOCATION_MGMT_CONFIRM_TOGGLE'
    | 'LOCATION_MGMT_SCHEDULE_MENU'
    | 'LOCATION_MGMT_SCHEDULE_TYPE'
    | 'LOCATION_MGMT_SCHEDULE_TIME'
    | 'LOCATION_MGMT_SCHEDULE_CONFIRM'
